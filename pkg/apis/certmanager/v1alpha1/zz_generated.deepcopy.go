...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CFSSLCertificateConfig) DeepCopyInto(out *CFSSLCertificateConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CFSSLCertificateConfig.
func (in *CFSSLCertificateConfig) DeepCopy() *CFSSLCertificateConfig {
	if in == nil {
		return nil
	}
	out := new(CFSSLCertificateConfig)
	in.DeepCopyInto(out)
	return out
}
